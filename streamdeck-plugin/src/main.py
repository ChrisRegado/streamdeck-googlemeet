...
from event_handlers.emoji_react_event_handler import EMOJI_REACTION_PARAMS, EmojiReactionEventHandler
...
def register_handlers(
    ...
    for emoji_char, action_uri in EMOJI_REACTION_PARAMS:
        event_handlers += EmojiReactionEventHandler(stream_deck_client, browser_manager, emoji_char, action_uri)
